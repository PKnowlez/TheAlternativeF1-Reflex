...
rx.text(
    r"""After the race, Boz let loose in the media pen with a fiery post-race critique:""",
    color="#E0E0E0",
    font_size="md",
    line_height="1.7",
    margin_bottom="4",
...
rx.text(
    ...
    "author": "Insiders: Senad (Boz) & Patrick",
